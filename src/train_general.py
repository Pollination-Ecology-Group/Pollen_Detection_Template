...
STAGED_AREA = os.getenv("STAGED_AREA", "/home/meow/cesnet_cloud/bucket/PROJECT_PREFIX/Staged_area/")
STAGED_NEGATIVES = os.getenv("STAGED_NEGATIVES", "/home/meow/cesnet_cloud/bucket/PROJECT_PREFIX/Staged_negatives")
STAGED_CURATED = os.getenv("STAGED_CURATED", "/home/meow/cesnet_cloud/bucket/PROJECT_PREFIX/Curated_Retrain_Data")
DATASET_ROOT = os.getenv("DATASET_ROOT", "/tmp/general_pollen_dataset")
MODEL_DIR = os.getenv("MODEL_DIR", "./models/general_pollen")
